...
plt.keel_pro_o_K_pressure={'pro_o_K_gas_press'};

pltTitle = {'Pro-Oceanus data - Carbon Dioxide at 1m',...
            'Pro-Oceanus data - Raw sensor CO2',...
            'Pro-Oceanus data - AZPC from sensor',...
            'Pro-Aceanus Temperature, Humity and Pressure',...
            'Pro-Oceanus on keel data - Pressure'};
  ...
  if rows>0
    ...
    switch varStr
      case {'keel_pro_o_K_conc'}
        pt = 1; varYlim = [250 550];
      case {'pro_o_K_raw_co2','keel_pro_o_K_AZPC'}
        pt = 1;
