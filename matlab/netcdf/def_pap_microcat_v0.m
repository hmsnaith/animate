function [a,d,v] = def_pap_microcat(meta, rows, nvars)
% Define instrument specific metadata, variables and variable attributes
...
data_type = 'CTD'; % data type being written - will be CTD for microcats, may be input parameter if make generic
a.os_name = ['OS_' platform '_' datestr(sdate,'yyyymm') '_' data_mode '_' data_type];
OS_name=['OS_' site.os_platform_code '_', OS_date '_' dat.mode '_' dat.data_type, '.nc')
