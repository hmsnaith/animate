...
%         currently recognises TEMP, CNDC, PSAL, PRES, PCO2, PCO2_PPM
...
long_names = struct('TEMP', 'Temperature', ...
                    ...
                    'PCO2_PPM', 'Partial Pressure of CO2' ...
                    );
standard_names = struct('TEMP', 'sea_water_temperature', ...
                        ...
                        'PCO2_PPM', 'surface_partial_pressure_of_carbon_dioxide_in_sea_water' ...
                        );
