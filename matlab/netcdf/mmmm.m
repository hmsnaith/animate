...
nc{'TEMP'}={'DateTime','Depth','Latitude','Longitude'};
nc{'Conductivity'}={'DateTime','Depth','Latitude','Longitude'};
nc{'PRES'}={'DateTime','Depth','Latitude','Longitude'};
nc{'PSAL'}={'DateTime','Depth','Latitude','Longitude'};
nc{'QC_TEMP'}={'DateTime','Depth','Latitude','Longitude'};
nc{'QC_Conductivity'}={'DateTime','Depth','Latitude','Longitude'};
nc{'QC_PRES'}={'DateTime','Depth','Latitude','Longitude'};
nc{'QC_PSAL'}={'DateTime','Depth','Latitude','Longitude'};
...
nc{'Depthx'}(1)=0;
nc{'TEMP'}(:)=ncfloat(T');
nc{'Conductivity'}(:)=ncfloat(C');
nc{'PRES'}(:)=ncfloat(P');
nc{'PSAL'}(:)=ncfloat(S');
nc{'QC_TEMP'}(:)=ncint(TQ');
nc{'QC_Conductivity'}(:)=ncint(CQ');
nc{'QC_PRES'}(:)=ncint(PQ');
nc{'QC_PSAL'}(:)=ncint(SQ');
...
nc{'QC_TEMP'}=ncfloat('DateTime','Depth','Latitude','Longitude');
nc{'QC_Conductivity'}=ncfloat('DateTime','Depth','Latitude','Longitude');
nc{'QC_PRES'}=ncfloat('DateTime','Depth','Latitude','Longitude');
nc{'QC_PSAL'}=ncfloat('DateTime','Depth','Latitude','Longitude');
