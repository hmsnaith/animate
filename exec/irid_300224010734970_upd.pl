...
$mooring="PAP201507";   # mred May 2010   changed for 2014
...
if ($data =~ m/5206001e4525d187,1,DAS 1/)
    {
    ($WMAN,$data_date,$data_time,$WMAN_sn,$mess_no,$sys_id,$lat0,$lon0,$wind_speed,$wind_dir,$wind_gust,    $sea_temp, $air_temp, $humidity, $dew_temp, $air_temp_2, $humidity_2, $dew_temp_2, $air_press, $Hsig, $Hmax, $wave_TP, $wave_dir, $last)=split(/,/,$data,24);
