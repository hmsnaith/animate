...
'last 10 readings is included as an indicator of convergence to a final reading. '...
...
rt_sample_period_text='every 12 hours';   %platform_reporting_frequency
%
...
mc_sensor_serial_no(1)=13397;	mc_v(1)=1;  	Wvar(1)=0; 		mc_stype(1)=10; 	qc_var(1)=-1;		
sensor_serial_str='29-097-45';
sensor_serial_no(1)=2909745;
...
for jj=1:sz_kq(1,1)
    PCO2_mu_atms_std(jj,1)=nanstd(all_PCO2_mu_atms(((kq(jj)-n_pro_o_std):kq(jj)),n_pro_o));
