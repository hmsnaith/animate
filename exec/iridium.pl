...
$to_address="mred\@noc.soton.ac.uk,migcha\@noc.soton.ac.uk,joc\@noc.soton.ac.uk,joncamoceandata\@gmail.com,migcha\@noc.ac.uk,bodcnocs\@bodc.ac.uk";   # address that SBD message is sent to
local $/ = "";
